    ...
    override fun onCreate() {
        ...
        try {
            ...
            val config = CrashReporterConfiguration()
                    ...
                    .setAlertDialogPositiveButton(getString(R.string.crash_send_button))
                    .setAlertDialogNegativeButton(getString(R.string.crash_cancel_button))
                    .setAlertDialogTheme(R.style.CrashDialogTheme)
